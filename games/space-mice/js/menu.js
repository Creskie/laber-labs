...
var Menu = {
    preload: function() {
        ...
        game.load.spritesheet('cat', 'assets/BigCat.png', 260*1.058, 220);
	     },
    ...
    create: function() {
        ...
        //game.add.text(425, 410, "Press SPACE for Adventure", {fontSize: '24px', fill: "#FFF", align: "center"});
        game.add.text(435, 410, " Press SHIFT for Credits", {fontSize: '24px', fill: "#FFF", align: "center"});
        game.add.text(425, 440, "Press ESCAPE for Controls", {fontSize: '24px', fill: "#FFF", align: "center"});
